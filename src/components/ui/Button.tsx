...
const buttonVariants = cva("flex item-center justify-center rounded-md font-medium text-white duration-300 dark:text-black disabled:bg-indigo-400 disabled:hover:bg-indigo-400 disabled:cursor-not-allowed", {
  variants: {
    variant: {
      // ** FILLED
      ...
      cancel: "bg-gray-300 text-gray-700 dark:bg-[#f5f5fa] dark:text-darc hover:bg-gray-400 dark:hover:bg-gray-200",
